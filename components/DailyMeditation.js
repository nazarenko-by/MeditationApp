...
const getThemeStyles = (isDarkMode) => ({
	text: {
		color: isDarkMode ? COLORS.gray2 : COLORS.primary,
	},
	cardContainer: {
		shadowColor: isDarkMode ? COLORS.darkBackground : COLORS.lightWhite,
	},
})
	...
	return (
		<View style={styles.container}>
			<View style={styles.header}>
				<Text style={{ ...styles.headerTitle, ...themeStyles.text }}>Daily Meditation</Text>
			</View>
					...
					data?.map((meditation) => (
						...
						>
							<View style={styles.logoContainer}>
								<Image source={{ uri: meditation.image }} resizeMode="cover" style={styles.logoImage} />
							</View>
